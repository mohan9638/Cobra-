...
OWNER_ID = 5917152380 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [5917152380,6302749609]
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/ASTRONAUT_Official_1") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/ASTRONAUT_Official_1") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/ASTRONAUT_Official_1")                              
                ],           
            ]
      )
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[Astronaut](@Astronaut_OFFICIAL_2)"
    if raw_text3 == '1':
        CR = '[ASTRONAUT](@ASTRONAUT_OFFICIAL_2)'
    elif raw_text3:
        try:
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    Show = f"**📥 Dσɯɳʅσαԃιɳɠ **\n\n**📝ɴᴀᴍᴇ » ** `{name}\n\n🔗ᴛᴏᴛᴀʟ ᴜʀʟ » {len(links)}\n\n🗂️ɪɴᴅᴇx » {str(count)}/{len(links)}\n\n🌐ʀᴇᴍᴀɪɴɪɴɢ ᴜʀʟ » {remaining_links}\n\n❄ǫᴜᴀʟɪᴛʏ » {res}`\n\n**🔗ᴜʀʟ »` kya Karoge Url Dekh ke` ** \n\n🤖𝗕𝗢𝗧 𝗠𝗔𝗗𝗘 𝗕𝗬 ➤ 『ASTRONAUT』\n\n Download by Astronaut bhai "
    ...
    await m.reply_text(f"<pre><code>『DOWNLOADING COMPLETED』</code></pre>")                 
